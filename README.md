...
| 4 | Broneeringu tegemine korrektsete andmetega | 1. Ava avalik broneerimisleht. <br> 2. Vali admini poolt lisatud kuupäev. <br> 3. Vali vaba kellaaeg. <br> 4. Sisesta nimi `Test Klient`. <br> 5. Sisesta telefon `55555555`. <br> 6. Sisesta e-post `test@test.ee`. <br> 7. Sisesta auto `BMW E46`. <br> 8. Sisesta registreerimisnumber `123ABC`. <br> 9. Vali velje suurus `17`. <br> 10. Vali teenus `Täisvahetus`. <br> 11. Vajuta broneerimise nuppu. | Süsteem salvestab broneeringu ja kuvab kasutajale kinnitusteate. Test õnnestub, kui broneering on nähtav ka administraatori vaates. | Õnnestus | Tavakasutuse test. |
